...
The Alerphis Rift is the largest rift-type anomaly found within the Ehrelis Arcanocracy, and it spans a contiguous area of 82,403 km$^2$ based on reports from the first Reforestry Expedition$^{[1]}$. The rift presents itself as an almost viscous black fluid (or gas), forming the appearance of a [[Black Lakes|Black Lake]]. 
...
Recent collaborations between the Ehrelis Arcanocracy and its primary tributary corporation [[HeartwoodCivic]]$^{[5,6]}$, have also hinted at new$^{\tiny\text{(Patent Pending)}}$ arcanodevlopments to increase the quality of life (and profits) of the average Ehrelian.
